package calc;
	...
	public class CalculatorUsingLayer extends JFrame implements ActionListener
	{
	    /**
		 * 
		 */
	    ...
	    {
	    	CalculatorUsingLayer calculator = new CalculatorUsingLayer();
